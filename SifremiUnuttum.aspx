...
<body class="newStyle3" style="height: 861px">
    <form id="form1" runat="server" class="auto-style1" style="background-image: url('SkyBg.jpg')">
        ...
        <div style="margin-left: auto; margin-right: auto; margin-bottom: auto;" class="auto-style7">
            ...
            <br />
            <div>
            <strong>E-posta veya Cep Telefonu :</strong><asp:TextBox ID="TxtNumara" runat="server" CssClass="auto-style6" Width="351px"></asp:TextBox>
            </div>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button6" runat="server" Text="Devam" CssClass="btn btn-warning" Width="225px" OnClick="Button6_Click" />
