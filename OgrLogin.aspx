<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OgrLogin.aspx.cs" Inherits="OgrLogin" %>
<!DOCTYPE html>
...
<body class="newStyle3" style="height: 899px">
    <form id="form1" runat="server" class="auto-style1" style="background-image: url('SkyBg.jpg')">
        ...
        <div style="width: 700px; margin-left: auto; margin-right: auto; margin-bottom: auto;" class="text-left">
            <h2 class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Öğrenci Giriş Ekranı</h2>          
            <br />
            <br />
            <br />
            ...
            <asp:TextBox ID="TxtSifre" runat="server" CssClass="form-control" TextMode="Password" Width="699px"></asp:TextBox>
            </div>
            <br />
